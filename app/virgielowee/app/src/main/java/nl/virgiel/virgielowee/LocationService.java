...
public class LocationService implements LocationListener {
    ...
    public LocationService(MainActivity context, GoogleApiClient client, CompassFragment compassFragment) {
        this.mGoogleApiClient = client;
        this.context = context;
        TOKO.setLatitude(52.007841);
        TOKO.setLongitude(4.358576);

        mCompassFragment = compassFragment;
        mCompassService = new CompassService(context);
    }

    public Location getToko() {
        return TOKO;
    }

    public void update() {
        mCompassFragment.updateArrow(getAngle());
    }
